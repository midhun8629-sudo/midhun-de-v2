  ...
  return (
    <section id="projects" className="py-20">
      <h1 className="heading">
        {portfolioContent.projectsSection.heading}{" "}
        <span className="text-purple">
          {portfolioContent.projectsSection.accent}
        </span>
      </h1>
      ...
      <div className="mt-10 flex flex-wrap items-center justify-center gap-x-24 gap-y-8 p-4">
        {projects.map(
          ({ id, des, iconLists, img, link, sourceCode, title }) => (
            ...
            >
              <PinContainer
                title={portfolioContent.projectsSection.hoverLabel}
                href={link}
              >
                ...
                <div className="mb-3 mt-7 flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-center">
                    ...
                    >
                      {portfolioContent.projectsSection.linkLabel}
                    </Link>
