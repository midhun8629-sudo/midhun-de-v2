    ...
    <footer id="contact" className="mb-[100px] w-full pb-10 md:mb-auto">
      ...
      <div className="flex flex-col items-center">
        <h1 className="heading lg:max-w-[45vw]">
          ...
          <span className="text-purple">
            {portfolioContent.contact.accent}
          </span>
        </h1>
        ...
        >
          <MagicButton
            title={portfolioContent.contact.button}
      ...
      <div className="relative z-[999] mt-16 flex flex-col items-center justify-between md:flex-row">
        <p className="text-sm font-light md:text-base md:font-normal">
          ...
          <Link
            href={portfolioContent.owner.github}
            target="_blank"
            rel="noreferrer noopener"
            className="text-purple"
          >
            {portfolioContent.contact.copyrightName}
          </Link>{" "}
          |{" "}
          <Link href={links.sourceCode} className="underline">
            {portfolioContent.contact.sourceLabel}
          </Link>
        </p>
