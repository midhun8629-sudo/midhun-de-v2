  ...
  return (
    <section id="vision" className="w-full py-20">
      <h1 className="heading">
        {portfolioContent.visionSection.heading}{" "}
        <span className="text-purple">
          {portfolioContent.visionSection.accent}
        </span>
      </h1>

      <div className="my-20 flex flex-col items-center justify-center gap-4 lg:flex-row">
        <Card
          title={portfolioContent.approach[0].title}
          icon={
            <MagicButton title={portfolioContent.approach[0].phase} asChild />
          }
          description={portfolioContent.approach[0].description}
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          title={portfolioContent.approach[1].title}
          icon={
            <MagicButton title={portfolioContent.approach[1].phase} asChild />
          }
          description={portfolioContent.approach[1].description}
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          title={portfolioContent.approach[2].title}
          icon={
            <MagicButton title={portfolioContent.approach[2].phase} asChild />
          }
          description={portfolioContent.approach[2].description}
        >
          <CanvasRevealEffect
            animationSpeed={3}
